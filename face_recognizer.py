...
def main(): 
	...
	face_database = get_face_dists(FR_model)

	detect_face(video_capture, threshold, face_cascade, FR_model, face_database)


def detect_face(video_capture, threshold, face_cascade, FR_model, face_database): 
	while True:
